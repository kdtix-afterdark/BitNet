...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--model", type=str, help="Path to model file", required=False, default="models/bitnet-b1.58-2B-4T-bf16/ggml-model-f32-bitnet.gguf")
    ...
    parser.add_argument("-c", "--ctx-size", type=int, help="Size of the context window", required=False, default=8192)
